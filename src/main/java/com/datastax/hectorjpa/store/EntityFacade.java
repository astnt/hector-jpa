...
public class EntityFacade implements Serializable {
	 ...
	 *         otherwise false is returned.
	 */
	public boolean exists(OpenJPAStateManager stateManager, Keyspace keyspace, MetaCache metaCache) {
	 ...
	 * @return
	 */
	public Class<?> getStoredEntityType(Object oid, Keyspace keyspace, MetaCache metaCache) {
